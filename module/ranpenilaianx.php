...
$query_absen = "SELECT count(*) as total from employees where position_id = 1";
$result_absen = $connection->query($query_absen);
if ($result_absen->num_rows > 0) {
    while ($row_absen = $result_absen->fetch_assoc()) {
        $ttsx = $row_absen['total'];
    }
}
...
if ($result_absen->num_rows > 0) {
    while ($row_absen = $result_absen->fetch_assoc()) {
        ...
        $update = "UPDATE randem SET countx='0' WHERE position_id = 2";
        if ($connection->query($update) === false) {
            die($connection->error . __LINE__);
        ...
        $update = "UPDATE link_nilai SET user1='',user2='',user3='',nilai1='',nilai2='',nilai3='',tot='' WHERE position_id = 2";
        if ($connection->query($update) === false) {
            die($connection->error . __LINE__);
...
echo '<script>window.location.href = "https://absensi.leuwimunding.my.id/admin/system";</script>';
