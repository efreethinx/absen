...
?>
  ...
  <link href="<?php echo $site_url; ?>/content/logo/favicon.png" rel="icon" sizes="32x32"/>
  <meta content="<?php echo $site_url; ?>/content/logo/favicon.pngg" name="msapplication-TileImage"/>
  <link href="<?php echo $site_url; ?>/content/logo/favicon.png" rel="apple-touch-icon"/>
  <link href="<?php echo $site_url; ?>/content/logo/favicon.png" rel="icon" sizes="48x48"/>
  <link href="<?php echo $site_url; ?>/content/logo/favicon.png" rel="icon" sizes="72x72"/>
  <link href="<?php echo $site_url; ?>/content/logo/favicon.png" rel="icon" sizes="96x96"/>
  <link href="<?php echo $site_url; ?>/content/logo/favicon.png" rel="icon" sizes="168x168"/>
  <link href="<?php echo $site_url; ?>/content/logo/favicon.png" rel="icon" sizes="192x192"/>
  <link href="<?php echo $site_url; ?>/content/logo/favicon.png" rel="icon" sizes="512x512"/>
