...
<div class="">
            <div class="form-group basic">
                ...
                <div class="center">
                    <span class="title">Kalender Presensi</span>
    ...
    <table id="swdatatable" class="table table-bordered">
            <thead>
            <tr>
                <th colspan="3" style="text-align:center;">Keterangan Kalender Presensi</th>
            </tr>
            <tr>
            ...
            <tbody>
                ...
                <tr>
                    <td style="text-align:center;"><div class="p-3 mb-2 text-white" style="background-color:#28a745;">Masuk | Pulang</div></td>
                    <td style="text-align:center;">Tepat Waktu / Sudah Presensi</td>
                    <td style="text-align:center;"><i class="fa fa-times" style="color:#FF396F;" aria-hidden="true"></i></td>
                </tr>
                
                <tr>
                    <td style="text-align:center;"><div class="p-3 mb-2 text-white" style="background-color:#FF396F;">Masuk | Pulang</div></td>
                    <td style="text-align:center;">Telat Presensi / Belum Presensi</td>
                    <td style="text-align:center;"><i class="fa fa-times" style="color:#FF396F;" aria-hidden="true"></i></td>
                </tr>
                
                <tr>
                    <td style="text-align:center;"><div class="p-3 mb-2 text-white" style="background-color:#007bff;">Keterangan</div></td>
                    <td style="text-align:center;">Hari Nasional / Islam</td>
                    <td style="text-align:center;"><i class="fa fa-times" style="color:#FF396F;" aria-hidden="true"></i>
</td>
                </tr>
                
                <tr>
                    <td style="text-align:center;"><div class="p-3 mb-2 text-white" style="background-color:#6610f2;">Ulang Tahun</div></td>
                    <td style="text-align:center;">Ulang Tahun Rekan Kerja</td>
                    <td style="text-align:center;"><i class="fa fa-times" style="color:#FF396F;" aria-hidden="true"></i>
</td>
                </tr>
                ...
                <tr>
                    <td style="text-align:center;"><i class="fa fa-circle text-blue" style="color:#007bff;"></i> Keterangan</td>
                    <td style="text-align:center;">Hari Libur Kerja</td>
                    <td style="text-align:center;"><i class="fa fa-check" style="color:green;" aria-hidden="true"></i></td>
                </tr>
