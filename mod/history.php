...
if(!isset($_COOKIE['COOKIES_MEMBER']) && !isset($_COOKIE['COOKIES_COOKIES'])){
  ...
  echo'<!-- App Capsule -->
    ...
    <div class="card-body">
        ...
        <!-- UPDATE ABSENSI Hilangkan X  -->
        
        
        <div class="modal fade action-sheet inset" id="modal-showx" tabindex="-1" role="dialog" data-backdrop="static" data-keyboard="false" style="z-index:10000">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
