	...
	<body>
		...
		<header id="header">
			<div class="startp-mobile-nav fixed">
				<div class="logo">
					<a href="./"><img src="<?php echo $site_url; ?>/content/landing3.png" class="home-logo"></a>
				</div>
			</div>
						...
						<div class="collapse navbar-collapse mean-menu" id="navbarSupportedContent">
							<ul class="navbar-nav nav ml-auto">
								...
								<div class="others-option m">
									<a href="<?php echo $site_url; ?>/Presensi.apk" title="Download <?php echo $site_name; ?>" alt="Download <?php echo $site_name; ?>" class="btn btn-primary"><i aria-hidden="true" class="fa fa-download"></i> DOWNLOAD</a>
								</div>
							</ul>
						</div>
						<div class="others-option m">
							<a href="<?php echo $site_url; ?>/Presensi.apk" class="btn btn-primary"><i aria-hidden="true" class="fa fa-download"></i> DOWNLOAD</a>
						</div>
					</nav>
				</div>
			</div>
						...
						<div class="row h-100 justify-content-center align-items-center">
							<div class="col-lg-5">
								<div class="hero-content text-center text-white">
									<p>
										<img src="<?php echo $site_url; ?>/content/landing3.png" class="img-fluid" width="180px">
									</p>
									...
									<i aria-hidden="true" class="fa fa-check-circle"></i> Powered by FyOs
								</div>
							</div>
							<div class="col-lg-6">
		...
		<section class="ready-to-talk">
			<div class="container">
				<img src="<?php echo $site_url; ?>/content/landing3.png" title="Website <?php echo $site_name; ?>" alt="Website <?php echo $site_name; ?>">
				...
				<div class="row">
					...
					<div class="col-lg-4 col-md-12">
						<div class="single-footer-widget pl-5">
							...
							<ul class="list">
								<li><a href="http://kaprog.mm" title="Tentang Kami" alt="Tentang Kami">Tentang Kami</a></li>
								<li><a href="<?php echo $site_url; ?>/AbsensiOnline.apk" title="Platform Aplikasi" alt="Platform Aplikasi">Platform Aplikasi</a></li>
								<li><a href="http://kaprog.mm" title="Dukungan Teknologi" alt="Dukungan Teknologi">Dukungan Teknologi</a></li>
								<li><a href="http://kaprog.mm" title="Dukungan Pembayaran" alt="Dukungan Pembayaran">Dukungan Pembayaran</a></li>
								<li><a href="http://kaprog.mm" title="Ketentuan Layanan" alt="Ketentuan Layanan">Ketentuan Layanan</a></li>
								<li><a href="http://kaprog.mm" title="Pertanyaan Umum" alt="Pertanyaan Umum">Pertanyaan Umum</a></li>
							</ul>
						</div>
					</div>
					<div class="col-lg-4 col-md-12">
						<div class="single-footer-widget pl-5">
							...
							<ul class="social-links">
								<li><a href="https://www.youtube.com/channel/UCRtUdMQMshmXbkL1bpkBFFg" class="youtube"><i data-feather="youtube"></i></a></li>
								<li><a href="https://facebook.com/" class="facebook"><i data-feather="facebook"></i></a></li>
								<li><a href="https://instagram.com/" class="instagram"><i data-feather="instagram"></i></a></li>
								<li><a href="https://twitter.com/" class="twitter"><i data-feather="twitter"></i></a></li>
							</ul>
							<br />
							<ul class="list">
								<li><a href="http://kaprog.mm">Hubungi Kami</a></li>
								<li><a href="http://kaprog.mm">Mitra & Jaringan</a></li>
							</ul>
						</div>
					</div>
					<div class="col-lg-12 col-md-12">
						<div class="copyright-area">
							Copyright ©2020-2021 <a class="text-white" href="http://kaprog.mm"> Kaprog MM</a> by <a class="text-white" href="http://kaprog.mm"> FyOs</a>.
						</div>
					</div>
				</div>
			</div>
