...
(function() {
    ...
    $('.btn-print-all').click(function (e) {
            ...
            if(type=='rekap'){
                var url = "./absensi/print?action=rekap&from="+month+"&to="+year+"&print=print"; 
            }
...
$(document).on('click', '.btn-modal', function(){
    ...
    document.getElementById("iframe-map").innerHTML ='<iframe src="mod/absensi/map.php?latitude='+latitude+'&longitude='+longitude+'&name='+name+'&idx='+id+'" frameborder="0" width="100%" height="400px" marginwidth="0" marginheight="0" scrolling="no">';
});
