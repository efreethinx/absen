...
presence.presence_date='$tgglx' ORDER BY presence.presence_id ASC";
        ...
        if($result_absen->num_rows > 0){
             ...
             if ($akses == '1')
             {
                 echo '<td class="text-center" style="background-color:DodgerBlue;">'.$no.'</td>'; 
      ...
      <thead>
      <tr>
                <th colspan="5" style="text-align:center;">Pegawai Tidak Hadir Tanggal : '.$jdtgl.'</th>
        </tr>
...
employees.position_id=position.position_id AND employees.shift_id = shift.shift_id AND employees.building_id = building.building_id ORDER BY employees.id ASC";
