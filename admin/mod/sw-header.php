...
<head>
  ...
  <meta content="FyOs" name="twitter:site"/>
  <meta content="FyOs" name="twitter:creator"/>
  ...
  <link rel="stylesheet" href="https://fonts.googleapis.com/css?family=Source+Sans+Pro:300,400,600,700,300italic,400italic,600italic">';
   ...
   if($mod =='lokasi'){
       echo '<link rel="stylesheet" href="./assets/mapes/leaflet.css">
       <link rel="stylesheet" href="./assets/mapes/L.Control.Locate.min.css">
';
...
<header class="main-header">
    ...
    <nav class="navbar navbar-static-top">
      ...
      <div class="navbar-custom-menu">
        ...
        $query="SELECT presence.employees_id,presence.time_in,presence.time_out,employees.employees_name FROM presence,employees WHERE presence.employees_id=employees.id AND presence.presence_date='$date' ORDER BY presence.presence_id DESC";
        $result_notif = $connection->query($query);
        
        //$query="SELECT * FROM pengajuan_dnl WHERE akses = 0 AND tanggal = '$date'";
        
        $query="SELECT pengajuan_dnl.employess_id, pengajuan_dnl.tanggal , pengajuan_dnl.akses,pengajuan_dnl.keterangan , employees.employees_name , employees.id FROM pengajuan_dnl,employees WHERE pengajuan_dnl.employess_id = employees.id and pengajuan_dnl.tanggal = '$date'";
        $result_notifX = $connection->query($query);
        ...
        <!-- Notifications: style can be found in dropdown.less -->
          <li class="dropdown notifications-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              ...
              <span class="label label-warning">'.$result_notifX->num_rows.'</span>
            </a>
            <ul class="dropdown-menu">
              <li class="header">Ada '.$result_notifX->num_rows.' Ajuan Dinas Luar Hari Ini </li>
              <li>
                <!-- inner menu: contains the actual data -->
                <ul class="menu">';
                while ($row= $result_notifX->fetch_assoc()) {
                  echo'
                  <li>';
                  
                  if ($row['akses'] == 0){
                      
                      echo '<a href="dnl"><p class="text-danger"><strong>
                      '.$row['employees_name'].'</strong></p>
                      <i class="fa fa-envelope-o text-danger"></i>Keterangan : '.$row['keterangan'].'<br>( <i class="fa fa-times text-danger"></i> Belum Setujui)<br>';
                    echo'
                    </a>';
                      
                  }else{
                      echo '<a href="dnl"><p class="text-success"><strong>
                      '.$row['employees_name'].'</strong></p>
                      <i class="fa fa-envelope-open-o text-aqua"></i>Keterangan : '.$row['keterangan'].'<br> ( <i class="fa fa-check text-success"></i> Di Setujui)<br>';
                    echo'
                    </a>';
                  }
        ...
        <li class="dropdown">
              ...
              <ul class="dropdown-menu" role="menu">';?>
                <li><a href="javascript:void();" onClick="location.href='./logout';"><i class="fa fa-sign-out text-red"></i> Logout</a></li>
              </ul>
            </li>
