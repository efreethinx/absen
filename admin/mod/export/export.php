    ...
    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
      <div class="box box-solid">
        <div class="box-header with-border">
          <h3 class="box-title"><b>Input Data Izin/Sakit</b></h3>
        ...
        <div class="box-body">
          <div class="table-responsive">';
            ...
            <tbody>';
            $query="SELECT employees.*,position.position_name,presence.employees_id,presence.time_in,presence.time_out,presence.picture_in,presence.present_id,
